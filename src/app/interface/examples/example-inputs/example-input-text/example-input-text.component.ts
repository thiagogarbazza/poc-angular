...
@Component({
  selector: 'app-example-input-text',
  templateUrl: './example-input-text.component.html',
  styleUrls: ['./example-input-text.component.scss']
})
export class ExampleInputTextComponent implements OnInit {
